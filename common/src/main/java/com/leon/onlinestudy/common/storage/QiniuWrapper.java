package com.leon.onlinestudy.common.storage;

import com.leon.onlinestudy.common.util.PropertiesUtil;
...
public class QiniuWrapper {
	...
	static{
		...
		Configuration cfg = new Configuration(Zone.zone2());//设置空间上传域名zone2为华南
