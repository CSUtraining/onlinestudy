package com.leon.onlinestudy.service.web.auth;

import com.leon.onlinestudy.common.util.JsonUtil;
import com.leon.onlinestudy.common.web.HttpHelper;
...
public class AuthFilter extends FormAuthenticationFilter {
	//登录过期即未登录则返回504错误码
	private static final Integer SHIRO_TIME_OUT = 504;
